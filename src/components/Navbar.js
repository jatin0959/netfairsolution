...
function Navbar() {
  ...
  useEffect(() => {
    ...
    const fetchUserData = async () => {
      try {
        const userRef = firebase.firestore().collection('users').doc(user); // Replace USER_ID with the actual user ID
    ...
    const handleLogout = async () => {
      try {
        ...
        router.push("/sign-in"); // Replace '/login' with your login page route
      } catch (error) {
  ...
  return (
    <div>
      <Disclosure as="nav">
        <Disclosure.Button className="absolute top-4 right-2 inline-flex items-center peer justify-center rounded-md p-2 text-gray-800 hover:bg-gray-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white group mb-8">
          <GiHamburgerMenu
        ...
        <div className="p-6 w-1/2 h-screen overflow-y-auto bg-white z-20 fixed top-0 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
          ...
          {userdata && userdata.fullname ? userdata.fullname.charAt(0) : ""}
                </div>
                <div className="text-center mt-4">
                  <p className="text-sm text-black">{userdata && userdata.fullname}</p>
                  <p className="text-xs text-black mt-1">{userdata && userdata.email}</p>
                </div>
      </div>
      <hr class="mt-6 border-gray-600" />
        ...
        <li>
          ...
          <li>
            <a href="javascript:void(0)"
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
            <img src="cards.png" className="w-[18px] h-[18px] mr-4" />
          ...
          <li>
            <a href="javascript:void(0)"
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
               <img src="card.png" className="w-[18px] h-[18px] mr-4" />
          ...
          <li>
            <a href="javascript:void(0)"
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
               <img src="interest.png" className="w-[18px] h-[18px] mr-4" />
              <span>analytics</span>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)"
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
               <img src="diagnostic.png" className="w-[18px] h-[18px] mr-4" />
              <span>Setting</span>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)"
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
               <img src="help-desk.png" className="w-[18px] h-[18px] mr-4" />
              <span>Support</span>
            </a>
          </li>
          <li>
            <a href="javascript:void(0)"
              class="text-black hover:text-blue-600 text-sm flex items-center hover:bg-blue-50 rounded px-4 py-3 transition-all">
               <img src="reset.png" className="w-[18px] h-[18px] mr-4" />
              <span>Reset PIN</span>
            </a>
          </li>
